-- 000091_seed_aliases_srk_fourth_wave.up.sql
-- M14-03f: 第四波 14 キャラの表記プリセット srk のエイリアス(移動系 9 code は新 12 キャラのみ)
...
SELECT (SELECT id FROM presets WHERE code = 'srk'), m.id, m.character_id, v.alias_text, v.alias_text_en
FROM moves m
...
SELECT (SELECT id FROM presets WHERE code = 'srk'), m.id, m.character_id, v.alias_text
FROM moves m
JOIN characters c ON c.id = m.character_id
CROSS JOIN (
...
CROSS JOIN (
  ...
  UNION ALL SELECT 'crouching_heavy_kick', 'cr.HK', NULL
  UNION ALL SELECT 'crouching_heavy_punch', 'cr.HP', NULL
  UNION ALL SELECT 'crouching_light_kick', 'cr.LK', NULL
  UNION ALL SELECT 'crouching_light_punch', 'cr.LP', NULL
  UNION ALL SELECT 'crouching_medium_kick', 'cr.MK', NULL
  UNION ALL SELECT 'crouching_medium_punch', 'cr.MP', NULL
  ...
  UNION ALL SELECT 'rush_crouching_heavy_kick', 'DR > cr.HK', NULL
  UNION ALL SELECT 'rush_crouching_heavy_punch', 'DR > cr.HP', NULL
  UNION ALL SELECT 'rush_crouching_light_kick', 'DR > cr.LK', NULL
  UNION ALL SELECT 'rush_crouching_light_punch', 'DR > cr.LP', NULL
  UNION ALL SELECT 'rush_crouching_medium_kick', 'DR > cr.MK', NULL
  UNION ALL SELECT 'rush_crouching_medium_punch', 'DR > cr.MP', NULL
  ...
  UNION ALL SELECT 'rush_standing_heavy_kick', 'DR > st.HK', NULL
  UNION ALL SELECT 'rush_standing_heavy_punch', 'DR > st.HP', NULL
  UNION ALL SELECT 'rush_standing_light_kick', 'DR > st.LK', NULL
  UNION ALL SELECT 'rush_standing_light_punch', 'DR > st.LP', NULL
  UNION ALL SELECT 'rush_standing_medium_kick', 'DR > st.MK', NULL
  UNION ALL SELECT 'rush_standing_medium_punch', 'DR > st.MP', NULL
  ...
  UNION ALL SELECT 'standing_heavy_kick', 'st.HK', NULL
  UNION ALL SELECT 'standing_heavy_punch', 'st.HP', NULL
  UNION ALL SELECT 'standing_light_kick', 'st.LK', NULL
  UNION ALL SELECT 'standing_light_punch', 'st.LP', NULL
  UNION ALL SELECT 'standing_medium_kick', 'st.MK', NULL
  UNION ALL SELECT 'standing_medium_punch', 'st.MP', NULL
...
CROSS JOIN (
  ...
  UNION ALL SELECT 'rush_crouching_medium_kick', 'DR > cr.MK'
  UNION ALL SELECT 'rush_crouching_medium_punch', 'DR > cr.MP'
  UNION ALL SELECT 'rush_flying_sumo_press', 'DR > 2MK'
